...
with open(word_list, 'r') as fichier:
 ...
 #-------------------------------------------------.bak-------------------------------
            ...
            if mode == 0:
                commande0 = subprocess.run(["wget", url+ligne_wordlist+extension0], capture_output=True, text=True)
                sortie0 = commande.stdout + commande.stderr
                verification_erreur0 = any(chaque_erreur in sortie0 for chaque_erreur in erreurs)
                if verification_erreur0:
                    print(f"Essai numéro {compteur} non résultant pour {ligne_wordlist+extension0}, {nombre_fichier} total/totaux trouvé(s) ")
                    compteur = compteur + 1
                else: 
                    print(f"==============================================================\nFichier {ligne_wordlist+extension0} a été téléchargé\n==============================================================")
                    nombre_fichier = nombre_fichier+1
            if mode == 3:
#-------------------------------------------------.backup-------------------------------
                ...
                if verification_erreur1:
                    print(f"Essai numéro {compteur} non résultant pour {ligne_wordlist+extension1}, {nombre_fichier} total/totaux trouvé(s)")
                    compteur = compteur + 1
                else: 
                    nombre_fichier = nombre_fichier+1
...
#-------------------------------------------------.old-------------------------------
                ...
                if verification_erreur2:
                    print(f"Essai numéro {compteur} non résultant pour {ligne_wordlist+extension2}, {nombre_fichier} total/totaux trouvé(s) ")
                    compteur = compteur + 1
                else: 
                    nombre_fichier = nombre_fichier+1
...
#-------------------------------------------------.swp-------------------------------
                ...
                if verification_erreur3:
                    print(f"Essai numéro {compteur} non résultant pour {ligne_wordlist+extension3}, {nombre_fichier} total/totaux trouvé(s) ")
                    compteur = compteur + 1
                else: 
                    nombre_fichier = nombre_fichier+1
...
#-------------------------------------------------extesion ~-------------------------------
                ...
                if verification_erreur4:
                    print(f"Essai numéro {compteur} non résultant pour {ligne_wordlist+extension4}, {nombre_fichier} total/totaux trouvé(s) ")
                    compteur = compteur + 1
                else: 
                    nombre_fichier = nombre_fichier+1
...
#-------------------------------------------------tmp-------------------------------
                ...
                if verification_erreur5:
                    print(f"Essai numéro {compteur} non résultant pour {ligne_wordlist+extension5}, {nombre_fichier} total/totaux trouvé(s) ")
                    compteur = compteur + 1
                else: 
                    nombre_fichier = nombre_fichier+1
...
#-------------------------------------------------.bak-------------------------------
            if verification_erreur:
                print(f"Essai numéro {compteur} non résultant pour {ligne_wordlist+extension}, {nombre_fichier} total/totaux trouvé(s) ")
                compteur = compteur + 1
            else: 
                nombre_fichier = nombre_fichier+1
